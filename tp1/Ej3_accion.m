...
l=0.2; % distancia entre ruedas
p_lfrente=[0.01 0.0 0.0]; % Posicion del frente del robot
p_lruedas=[0.0 0.01 0.0;0.0 -0.01 0.0];
p_gfrente=[]
p_gruedasl=[]
p_gruedasr=[]
theta=p_gbot(1,3);
...
figure;
hold on;
scatter(p_gbot(1,1), p_gbot(1,2),700,'r')
scatter(p_gbot(:,1), p_gbot(:,2),500,'b')
scatter(p_gfrente(1,:), p_gfrente(2,:),250,'k')
scatter(p_gruedasl(1,:), p_gruedasl(2,:),250,'g')
scatter(p_gruedasr(1,:), p_gruedasr(2,:),250,'g')
hold off;
